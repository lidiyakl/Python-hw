...
class InvalidMatrixError(Exception):
    def __init__(self, massage='Количество значений должно соответствовать размеру матрицы'):
...
class MatrixMultiplicationError(Exception):
    def __init__(self,
                 message='Число столбцов в первой матрице должно совпадать с числом строк во второй матрице'):
        self.message = message
        super().__init__(self.message)
